...
# 🕹️ Dots-and-Boxes
  Python tkinter GUI for Dots-and-Boxes Game
## 📜 How to run?
### 🧪 Jupyter Lab
  ...
  2) run Jupyter lab
      ...
      ```
        jupyter-lab
        ```
  3) Open "Dots-and-Boxes.ipynb" file & run 1st cell
  
### 🐍 Python 

  1) download & install python from [here](https://www.python.org/downloads/)
  2) create new project "*.py" & copy 1st cell of "Dots-and-Boxes.ipynb" file
  3) run project
...
## ⚙️ features:
  1) show winner/draw
  2) highlighted player's turn
  3) new scenario: box belongs to the player whom marked all 4 lines!

## 📸 Demo screenshot:

<img src='./Dots-and-Boxes.png' width=30% height=30%></img>
